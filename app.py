...
# --------------------------------------------------------------------
        ...
        data = db.execute("SELECT * FROM foodnames WHERE カロリー*0.9 < ? AND ? < カロリー*1.1 AND タンパク質*0.7 < ? AND ? < タンパク質*1.3 AND 脂質*0.7 < ? AND ? < 脂質*1.3 AND 炭水化物*0.7 < ? < 炭水化物*1.3", D, difP, difF, difCBH)
